...
describe("Ellipse - FarthestPointInDirection", () => {
    ...
    test.each<TestTuple>([
        ...
        ["Oval, right point", new Vector(4, 0), new Ellipse(new Vector(4, 2), 0, new Vector(0, 0)), new Vector(1, 0)],
        [
...
describe("Polygon - Circle", () => {
    ...
    test.each<TestTuple>([
        ["2r circle around origin", new Ellipse(new Vector(2, 2), 0, new Vector(0, 0)), Ellipse.Circle(2, 0, 0)],
