...
describe("Pooled - new", () => {
    ...
    ])("%p", (description: string, expected: TestPooledObject, beforePools: Map<string, [number, IPoolable[]]>,
...
describe("Pooled - free", () => {
    ...
    ])("%p", (description: string, beforePools: Map<string, [number, IPoolable[]]>,
        afterPools: Map<string, [number, IPoolable[]]>, obj: TestPooledObject) => {
        TestPooledObject.SetPools(beforePools);
...
describe("Pooled - init", () => {
    ...
    test.each<TestTuple>([
        ...
        [
            ...
            new Map([
                [TestPooledObject.POOL_KEY, [3, [
                    new TestPooledObject(7, true),
                    new TestPooledObject(8, true),
                    new TestPooledObject(9, true),
                ]]]
            ]),
            3,
        ],
        ...
        afterPools: Map<string, [number, IPoolable[]]>, size: number) => {
        TestPooledObject.SetPools(beforePools);
