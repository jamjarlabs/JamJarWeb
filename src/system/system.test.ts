...
describe("System - OnMessage", () => {
    ...
    test.each<TestTuple>([
        ...
        ["Register no payload", undefined, new TestSystem(new FakeMessageBus()), new Message(System.MESSAGE_REGISTER)],
        ["Register no payload", undefined, new TestSystem(new FakeMessageBus()), new Message(System.MESSAGE_REGISTER)],
        [
        ...
        [
            ...
            new TestSystem(new FakeMessageBus(), undefined, (): boolean => {
                throw "evaluator fail";
            }),
            new Message<[IEntity, Component[]]>(System.MESSAGE_REGISTER, [
                new FakeEntity(0),
                [new FakeComponent("test")],
        ...
        [
            ...
            new TestSystem(
                ...
                undefined,
                undefined,
                new Map([[3, new SystemEntity(new FakeEntity(3), [])]])
            ),
            new Message<IEntity>(System.MESSAGE_DEREGISTER, new FakeEntity(3)),
        ],
        [
