...
describe("SystemEntity - Get", () => {
    ...
    test.each<TestTuple>([
        ["No components, return undefined", undefined, new FakeEntity(0), [], "test"],
        [
...
describe("SystemEntity - Add", () => {
    ...
    test.each<TestTuple>([
        ...
        ["Success", undefined, new FakeEntity(0), [], new FakeComponent("test")],
    ])(
        "%p",
        (
            description: string,
...
describe("SystemEntity - Remove", () => {
    ...
    test.each<TestTuple>([
        ...
        "%p",
        (description: string, expected: Error | undefined, entity: IEntity, components: Component[], key: string) => {
            const systemEntity = new SystemEntity(entity, components);
            if (expected instanceof Error) {
                expect(() => {
