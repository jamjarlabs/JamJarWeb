...
describe("MessageBus - Dispatch", () => {
    ...
    test.each<TestTuple>([
        ["No messages", undefined, new MessageBus()],
        ["No subscribers for message", undefined, new MessageBus({}, [new Message("test")])],
        [
            ...
            new MessageBus(
                {
                    test: [
                        new FakeSubscriber(0, [
                            new Reactor("OnMessage", () => {
                                throw "onmessage fail";
                            }),
                        ]),
                    ],
                },
            ...
            new MessageBus(
                {
                    ...
                    "not-matching": [
                        ...
                        new FakeSubscriber(6, [
                            new Reactor("OnMessage", () => {
                                throw "unexpected match";
                            }),
                        ]),
                        new FakeSubscriber(7, [
                            new Reactor("OnMessage", () => {
                                throw "unexpected match";
                            }),
                        ]),
...
describe("MessageBus - Publish", () => {
    ...
    test.each<TestTuple>([["Success", undefined, new MessageBus(), new Message("test")]])(
        "%p",
        (description: string, expected: Error | undefined, messageBus: MessageBus, message: IMessage) => {
            if (expected instanceof Error) {
                expect(() => {
...
describe("MessageBus - Subscribe", () => {
    ...
    test.each<TestTuple>([
        ["Single type, no subscribers, success", undefined, new MessageBus(), new FakeSubscriber(0), "test"],
        [
            "Single type, already subscribers, success",
            undefined,
            new MessageBus({
                test: [new FakeSubscriber(0)],
            }),
            new FakeSubscriber(1),
            "test",
        ],
        [
            ...
            undefined,
            new MessageBus({
                test1: [new FakeSubscriber(0)],
                test2: [new FakeSubscriber(1)],
            }),
            new FakeSubscriber(3),
            ["test1", "test2", "test3"],
        ],
        ...
        (
            ...
            if (expected instanceof Error) {
                expect(() => {
                    messageBus.Subscribe(subscriber, types);
                }).toThrow(expected);
            } else {
...
describe("MessageBus - UnsubscribeAll", () => {
    ...
    test.each<TestTuple>([
        ["No subscribers", undefined, new MessageBus(), new FakeSubscriber(0)],
        [
        ...
        [
            ...
            new MessageBus({
                test1: [new FakeSubscriber(0)],
                test2: [new FakeSubscriber(1), new FakeSubscriber(4)],
                test3: [new FakeSubscriber(2), new FakeSubscriber(4)],
                test4: [new FakeSubscriber(4)],
                test5: [new FakeSubscriber(5)],
            }),
            new FakeSubscriber(4),
        ],
...
describe("MessageBus - Unsubscribe", () => {
    ...
    test.each<TestTuple>([
        ...
        [
            ...
            undefined,
            new MessageBus({
                test1: [new FakeSubscriber(3)],
                test2: [new FakeSubscriber(3)],
            }),
            new FakeSubscriber(3),
            ["test1", "test2", "test3"],
        ],
        ...
        (
            ...
            if (expected instanceof Error) {
                expect(() => {
                    messageBus.Unsubscribe(subscriber, types);
                }).toThrow(expected);
            } else {
